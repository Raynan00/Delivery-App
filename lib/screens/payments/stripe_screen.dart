...
class _StripeScreenState extends State<StripeScreen> {
  ...
  buildBody() {
    String initial_url =
        "${AppConfig.BASE_URL}/stripe?payment_type=${widget.payment_type}&combined_order_id=${_combined_order_id}&amount=${widget.amount}&user_id=${seller_id.$}";
    ...
    if (_order_init == false &&
      ...
      return Container(
        child: Center(
          child: Text(AppLocalizations.of(context).common_date),
        ),
      );
    } else {
